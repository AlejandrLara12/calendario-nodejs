...
//   var arr = [{ email: 'demo@mail.com', user: "rlara", password: "admin"}, { email: 'juan@mail.com', user: "juan", password: "123456"}]; //array con la información de los usuarios a insertar
...
//       }
//     }else{
//       callback(null, "El usuario 'rlara' se ha registrado correctamente. </br>usuario: demo | password:admin") //Mostrar mensaje del usuario guardado con exito
//     }
//   });
// }
